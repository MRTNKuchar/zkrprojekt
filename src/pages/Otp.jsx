...
export default function Otp() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      case 'learn':    return <OtpLearn />
      case 'lab':      return <OtpLab />
      case 'terminal': return <OtpTerminal />
      default:         return null
    }
  }
        ...
        <div className="flex items-start justify-between gap-4 mb-6 flex-wrap">
          <div>
            ...
            <div className="text-xs mt-1" style={{ color: '#005515', fontFamily: 'Share Tech Mono, monospace' }}>
              /otp — Vernamova šifra — dokonalé utajení (Shannon, 1949)
            </div>
          </div>
          <div className="w-56 shrink-0">
            <InfoPanel type="classical" year="1917" security="perfect" />
          </div>
        </div>
