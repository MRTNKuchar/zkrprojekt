  ...
  return (
    <div className="tab-content">
      ...
      <div className="mt-4 border p-3 text-xs" style={{ borderColor: '#2a2a2a', color: '#505050', fontFamily: 'Share Tech Mono, monospace' }}>
        {tt.hint} &nbsp;
        <span style={{ color: '#b0b0b0' }}>show history</span> &nbsp;|&nbsp;
        <span style={{ color: '#b0b0b0' }}>show perfect</span> &nbsp;|&nbsp;
        <span style={{ color: '#b0b0b0' }}>show reuse</span> &nbsp;|&nbsp;
        <span style={{ color: '#b0b0b0' }}>show qkd</span> &nbsp;|&nbsp;
